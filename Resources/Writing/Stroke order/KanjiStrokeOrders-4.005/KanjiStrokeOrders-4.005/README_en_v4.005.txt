Kanji Stroke Order Font Version 4.005
=====================================

Released: 27 July 2025
Latest version: https://kanji.uk

1. INTRODUCTION
The Kanji Stroke Order Font provides stroke order diagrams for over
6,500 kanji, 180+ kana and some Latin characters. The Kanji Stroke
Order Font is intended for:

- Teachers of Japanese preparing classroom handouts; and
- Japanese learners seeking stroke guidance.

Beware that Japanese stroke order can differ from the stroke order
used in other languages that use Chinese characters.

2. INSTALLATION AND USAGE
  i. Download and install KanjiStrokeOrders_v4.005.ttf like any other font.
 ii. In your document, set the font to KanjiStrokeOrders.
iii. Use 100 pt or larger as the font size to ensure the legibility of the
     stroke order numbers.

3. SUPPORTED PLATFORMS
As of version 4.002, the Kanji Stroke Order font works with Microsoft
Word on Macintosh as well as with Microsoft Word for Windows. This was
the most significant change from version 4.001 to version 4.002.
...
told that the Kanji Stroke Order Font works fine on OS X 10.4.11 if
you ignore the warning, so it's nothing to worry about. Thanks are
due to Phil for reporting this.

If you use the Anki flashcard program then the Anki website includes some
instructions on using custom fonts (such as the Kanji Stroke Order Font)
with that package. One user reported needing to rename the font filename
to remove the version number to get it to work with AnkiDroid.

4. LICENCE
This font may be freely distributed under the terms of the BSD-style licence
included with this archive in the file LICENCE.txt. This licence is very
...
and the AAAA and Wadoku projects.

5. INTEGRATION WITH JWPCE
...
please let me know by email: mail [at] kanji.uk. You
...
generally considered to be authoritative sometimes disagree on stroke
...
2016/09/25  4.001 Corrected errors reported by users
                  ...
                  Non-Jōyō kanji that have changed:
                    ...
                    U+9ED0 黐 Corrected to 23 strokes
                               ...
                               the Kanji Stroke Order Font. The reference I use
                               is http://kakijun.jp and this shows 22 strokes in
                               the image but 23 strokes in the reference
                               information. For this release I have settled on 23
                               strokes.
...
2016/07/04  4.000 Corrected errors reported by users and added some characters.
                  ...
                  Jōyō kanji that have changed:
                    U+5099 備 Improved appearance
                    U+50C5 僅 Corrected appearance and added stroke in line with JIS X 0213:2004
                    U+525D 剝 Added
                    U+52E7 勧 Adjusted position of some stroke order numbers for clarity without changing the order
                    U+55C5 嗅 Changed appearance
                    U+5632 嘲 Corrected appearance slightly in line with JIS X 0213:2004
                    U+5861 塡 Corrected appearance
                    U+5C5E 属 Corrected direction of stroke 4 (slightly controversial)
                    U+60E7 惧 Corrected appearance
                    ...
                    U+6DEB 淫 Corrected appearance in line with JIS X 0213:2004
                    U+6E80 満 Improved appearance slightly
                    U+6EBA 溺 Corrected appearance in line with JIS X 0213:2004
                    U+6F5F 潟 Corrected order of strokes 6 and 7
                    U+7B8B 箋 Corrected appearance
                    U+8108 脈 Improved appearance
                    U+81A8 膨 Improved appearance
                    U+81FC 臼 Reversed strokes 3 and 4
                    U+8328 茨 Corrected appearance in line with JIS X 0213:2004
                    U+845B 葛 Corrected appearance in line with JIS X 0213:2004
                    U+8511 蔑 Corrected appearance in line with JIS X 0213:2004
                    U+853D 蔽 Corrected appearance in line with JIS X 0213:2004
                    ...
                    U+8CED 賭 Corrected appearance
                    U+905C 遜 Added an extra stroke in line with JIS X 0213:2004
                    U+9061 遡 Corrected appearance in line with JIS X 0213:2004
                    U+91C8 釈 Improved appearance slightly by unmerging stroke 10 from the stroke itself
                    U+9699 隙 Corrected appearance in line with JIS X 0213:2004
                    U+96E2 離 Improved appearance (more like handwritten version)
                    U+96EA 雪 Improved appearance slightly
                    U+9905 餅 Corrected appearance in line with JIS X 0213:2004
                    U+990C 餌 Corrected appearance in line with JIS X 0213:2004
                  Non-Jōyō kanji that have changed:
                    U+2E84 ⺄ Added
                    U+2EA9 ⺩ Added
                    U+2EAC ⺬ Added
                    ...
                    U+5026 倦 Corrected stroke order and appearance
                    ...
                    U+5132 儲 Corrected stroke order and appearance
                    U+514E 兎 Corrected stroke order and appearance
                    U+5152 兒 Corrected stroke order
                    U+51A4 冤 Corrected stroke order and corrected appearance in line with JIS X 0213:2004
                    U+524F 剏 Corrected stroke order
                    U+52F5 勵 Corrected stroke order
                    U+5333 匳 Corrected stroke order
                    U+5342 卂 Added
                    U+537F 卿 Corrected appearance in line with JIS X 0213:2004
                    U+53A9 厩 Corrected appearance in line with JIS X 0213:2004
                    U+53DA 叚 Added
                    U+53DB 叛 Corrected appearance in line with JIS X 0213:2004
                    U+53DF 叟 Corrected appearance in line with JIS X 0213:2004
                    U+53F1 叱 Moved stroke 4 back to starting on right side. See also U+FAFF.
                    U+54C8 哈 Corrected stroke order
                    U+54E8 哨 Corrected appearance in line with JIS X 0213:2004
                    U+5557 啗 Corrected stroke order
                    U+558A 喊 Corrected stroke order
                    U+55B0 喰 Corrected appearance in line with JIS X 0213:2004
                    U+55BF 喿 Added
                    U+5618 嘘 Improved appearance of numbering
                    U+5642 噂 Corrected appearance in line with JIS X 0213:2004
                    U+564C 噌 Corrected appearance in line with JIS X 0213:2004
                    U+57A0 垠 Corrected stroke order
                    U+582F 堯 Reversed strokes 8 and 9
                    U+5835 堵 Corrected appearance in line with JIS X 0213:2004
                    U+583A 堺 Corrected stroke order
                    U+583D 堽 Corrected appearance and stroke order
                    U+590C 夌 Added
                    U+590D 复 Added
                    U+5967 奧 Corrected stroke order by swapping strokes 7 and 8
                    U+5969 奩 Corrected stroke order
                    U+5A29 娩 Corrected appearance in line with JIS X 0213:2004
                    ...
                    U+5C1E 尞 Added
                    U+5C51 屑 Corrected appearance in line with JIS X 0213:2004
                    U+5C60 屠 Corrected stroke order and appearance in line with JIS X 0213:2004
                    ...
                    U+5DF7 巷 Corrected appearance in line with JIS X 0213:2004
                    U+5E43 幃 Corrected stroke count
                    U+5E96 庖 Corrected appearance in line with JIS X 0213:2004
                    U+5F98 徘 Corrected appearance in line with JIS X 0213:2004
                    U+5FBD 徽 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+6062 恢 Corrected appearance in line with JIS X 0213:2004
                    U+60FB 惻 Corrected stroke order
                    U+6108 愈 Corrected appearance in line with JIS X 0213:2004
                    ...
                    U+6241 扁 Corrected appearance in line with JIS X 0213:2004
                    U+6283 抃 Corrected stroke order
                    U+6302 挂 Corrected stroke order
                    U+633D 挽 Corrected appearance in line with JIS X 0213:2004
                    U+6372 捲 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+6406 搆 Corrected stroke order
                    U+641C 搜 Corrected stroke order
                    U+647A 摺 Corrected appearance in line with JIS X 0213:2004
                    U+64B0 撰 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+64BB 撻 Corrected stroke order
                    U+64D4 擔 Corrected stroke order
                    U+64E2 擢 Corrected appearance in line with JIS X 0213:2004
                    U+6505 攅 Corrected stroke order
                    U+651C 攜 Corrected stroke order
                    U+6666 晦 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+66C9 曉 Reversed strokes 11 and 12
                    U+6736 朶 Corrected stroke order by swapping strokes 1 and 2
                    U+6753 杓 Corrected appearance in line with JIS X 0213:2004
                    U+6801 栁 Added
                    U+6883 梃 Corrected stroke order
                    U+688F 梏 Corrected stroke order
                    U+691B 椛 Changed appearance
                    U+6962 楢 Corrected appearance in line with JIS X 0213:2004
                    U+698A 榊 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+6994 榔 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+69CC 槌 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+69D0 槐 Corrected appearance and improved number placement
                    U+69F9 槹 Corrected stroke order
                    U+6A0B 樋 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+6A3D 樽 Corrected appearance in line with JIS X 0213:2004
                    U+6A48 橈 Improved position of numbers 9 and 12
                    U+6A9C 檜 Corrected stroke order
                    U+6ADB 櫛 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+6B1D 欝 Corrected stroke order
                    U+6B4E 歎 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+6C10 氐 Added
                    U+6C72 汲 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+6C9B 沛 Corrected in line with JIS X 0213:2004
                    U+6EA2 溢 Corrected appearance in line with JIS X 0213:2004
                    U+6ED4 滔 Corrected stroke order
                    U+6F23 漣 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+6F91 澑 Corrected stroke order
                    U+7009 瀉 Corrected stroke order
                    U+7015 瀕 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+701E 瀞 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+7026 瀦 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+7058 灘 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+707C 灼 Corrected appearance in line with JIS X 0213:2004
                    U+70AC 炬 Improved appearance
                    U+7109 焉 Corrected stroke order
                    U+7130 焰 Corrected stroke order
                    U+7149 煉 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+7155 煕 Corrected stroke order
                    U+717D 煽 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+723C 爼 Adjusted position digit 9
                    U+724C 牌 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+727D 牽 Fixed stroke order
                    U+7296 犖 Corrected stroke order
                    U+72E0 狠 Corrected stroke order
                    U+730A 猊 Corrected stroke order
                    U+7337 猷 Corrected appearance in line with JIS X 0213:2004
                    U+73F1 珱 Corrected stroke order
                    U+7425 琥 Reversed strokes 7 and 8
                    U+7470 瑰 Corrected appearance
                    U+74A2 璢 Corrected stroke order
                    U+74F2 瓲 Corrected stroke order
                    U+7511 甑 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+751E 甞 Improved position of numbering
                    U+754B 畋 Corrected stroke order
                    U+7550 畐 Added
                    U+75BC 疼 Corrected appearance in line with JIS X 0213:2004
                    U+75FA 痺 Improved appearance
                    ...
                    U+77A5 瞥 Corrected appearance in line with JIS X 0213:2004
                    U+77DA 矚 Corrected stroke order
                    U+78FD 磽 Improved position of number 10
                    U+7907 礇 Corrected stroke order
                    U+7941 祁 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+7947 祇 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+79B0 禰 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+79E3 秣 Corrected stroke order
                    U+79E4 秤 Corrected appearance in line with JIS X 0213:2004
                    U+79EC 秬 Corrected appearance
                    U+7A0D 稍 Corrected stroke order
                    U+7A17 稗 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+7A3B 稻 Corrected stroke order
                    U+7A62 穢 Adjusted position of some numbers
                    U+7A63 穣 Improved number spacing for 11 and 12
                    U+7A7F 穿 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+7AC4 竄 Corrected stroke order
                    U+7AC8 竈 Corrected stroke order in line with JIS X 0213:2004
                    U+7ACA 竊 Corrected appearance and corrected stroke count to 22
                    U+7B08 笈 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+7BC7 篇 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+7BF6 篶 Corrected stroke order
                    U+7C3E 簾 Corrected appearance in line with JIS X 0213:2004
                    U+7C6C 籬 Corrected appearance
                    U+7C7E 籾 Corrected appearance in line with JIS X 0213:2004
                    U+7CA6 粦 Added
                    ...
                    U+7FDF 翟 Added
                    U+7FEB 翫 Improved number positions and corrected appearance in line with JIS X 0213:2004
                    U+7FF0 翰 Corrected appearance in line with JIS X 0213:2004
                    U+80D6 胖 Corrected stroke order
                    U+817F 腿 Corrected appearance and stroke order in line with JIS X 0213:2004
                    ...
                    U+8258 艘 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+8271 艱 Corrected stroke order
                    U+8277 艷 Reversed order of strokes 16 and 17
                    U+8292 芒 Corrected appearance in line with JIS X 0213:2004
                    U+82A6 芦 Corrected appearance in line with JIS X 0213:2004
                    ...
                    U+84EC 蓬 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+854B 蕋 Corrected appearance and stroke order
                    U+8588 薈 Adjusted position of some numbers
                    U+85A9 薩 Corrected appearance in line with JIS X 0213:2004
                    U+85AF 薯 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+85F7 藷 Corrected stroke order and appearance in line with JIS X 0213:2004
                    U+86A4 蚤 Corrected stroke order
                    U+86F8 蛸 Corrected appearance in line with JIS X 0213:2004
                    U+8755 蝕 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+877F 蝿 Corrected position of numeral 6 and improved appearance of number 11
                    ...
                    U+8956 襖 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+8974 襴 Corrected stroke order
                    U+89E7 觧 Corrected stroke order
                    U+8A0A 訊 Corrected appearance in line with JIS X 0213:2004
                    U+8A3B 註 Corrected appearance in line with JIS X 0213:2004
                    U+8AB9 誹 Corrected appearance in line with JIS X 0213:2004
                    U+8AC2 諂 Corrected stroke order
                    U+8AFA 諺 Corrected appearance in line with JIS X 0213:2004
                    U+8B14 謔 Corrected stroke order
                    U+8B2C 謬 Corrected appearance in line with JIS X 0213:2004
                    U+8C50 豐 Reversed order of strokes 16 and 17
                    U+8C79 豹 Corrected appearance in line with JIS X 0213:2004
                    ...
                    U+8E30 踰 Improved appearance
                    U+8E48 蹈 Corrected stroke order
                    U+8F45 轅 Corrected stroke order
                    U+8F61 轡 Corrected stroke order
                    U+8FBB 辻 Corrected stroke order and appearance in line with JIS X 0213:2004
                    U+8FBF 辿 Corrected stroke order and appearance in line with JIS X 0213:2004
                    U+8FC2 迂 Corrected stroke order and appearance in line with JIS X 0213:2004
                    U+8FC4 迄 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+8FE6 迦 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+9017 逗 Corrected stroke order and appearance in line with JIS X 0213:2004
                    U+9019 這 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+9022 逢 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+903C 逼 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+9041 遁 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+9112 鄒 Corrected stroke order
                    U+912D 鄭 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+9130 鄰 Corrected shape and stroke order
                    U+914B 酋 Corrected appearance in line with JIS X 0213:2004
                    ...
                    U+9306 錆 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+939A 鎚 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+9453 鑓 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+95AD 閭 Adjusted position of some numbers
                    U+95BB 閻 Corrected stroke order
                    U+9677 陷 Corrected stroke order
                    U+9697 隗 Corrected appearance and reversed order of strokes 5 and 6
                    U+9708 霈 Corrected stroke order
                    U+9713 霓 Corrected stroke order
                    U+974D 靍 Added
                    U+974F 靏 Added
                    U+9768 靨 Corrected stroke order
                    U+9784 鞄 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+9798 鞘 Corrected appearance in line with JIS X 0213:2004
                    U+97DC 韜 Corrected stroke order
                    U+97DC 韜 Corrected stroke order
                    U+9824 頤 Corrected stroke order
                    U+98F4 飴 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+9910 餐 Corrected appearance in line with JIS X 0213:2004
                    U+9912 餒 Corrected stroke order
                    U+9921 餡 Corrected stroke order
                    U+992E 餮 Corrected stroke order
                    U+993D 餽 Improved appearance
                    U+9957 饗 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+9A19 騙 Corrected appearance and stroke order in line with JIS X 0213:2004
                    ...
                    U+9BD6 鯖 Corrected appearance and stroke order in line with JIS X 0213:2004
                    U+9BE2 鯢 Corrected stroke order
                    U+9C2F 鰯 Corrected appearance in line with JIS X 0213:2004
                    U+9C52 鱒 Corrected appearance in line with JIS X 0213:2004
                    U+9D60 鵠 Corrected stroke order and appearance in line with JIS X 0213:2004
                    U+9DBA 鶺 Corrected stroke order and improved appearance
                  ...
                  Other characters:
                    ...
                    U+FAFF 𠮟 Version of 叱 with stroke 4 starting on the left side,
                           ...
                           the Kanji Stroke Order Font's encoding space so I have
                           put it in the Private Use Area for users who would like
                           to use this version.
...
2010/10/05  2.015 Removed one stroke from U+6357, notionally in compliance with
                  ...
                  in this font that don't match JIS X 0213 but I don't intend to
...
2008/02/27: 2.005 More corrections from Scott Krogh: U+6570, U+6551, U+7B20,
                  ...
                  the font more consistent in appearance. Added a list of
...
for literally hundreds of characters for the version 4.0 release.
