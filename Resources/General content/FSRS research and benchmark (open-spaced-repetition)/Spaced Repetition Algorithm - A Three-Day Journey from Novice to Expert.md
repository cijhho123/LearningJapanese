> 中文原版：[间隔重复记忆算法：e 天内，从入门到入土。](https://l-m-sherlock.github.io/ZhiHuArchive/556020884.html)
...
In the Optimal Interval (OI) matrix, the columns depict how easy the material is and the rows depict how many times you've seen it. Initially, the entries in the matrix are filled using the SM-2 formulas that decide how long to wait before reviewing a card again.
