...
There's many resources to be consulted at this step. I recommend [[[yokubi]]]
...
The core deck I recommend for beginners is the
[kaishi](https://github.com/donkuri/Kaishi) deck. It is a curated collection of
beginner words and example sentences.

Don't get too hung up on finishing all of the deck (it's going to take you a
while depending on your pace). Just adding a good 500-1000 words to your
toolbelt will likely give you enough to get started and help you immensely for
the next step.
...
Be aware that RTK in itself is an old method/book. If you like the RTK approach,
I recommend at least checking out [Kodansha's Kanji Learner Course
(KKLC)](https://keystojapanese.com/) which is an improvement in almost any way.
Or alternatively read the next section about wanikani.
...
If you want an easy way to set up your mining software, I recommend reading
[Xelieu's lazy guide](https://lazyguidejp.github.io/jp-lazy-guide/) which walks you
through the whole process.

Once you have set up your mining deck and got the workflow down, you can begin
*looping*.
 ...
 * 2025-04-02: Fixed broken lazy guide link
 * 2025-03-22: Changed sakubi to yokubi, and reworked some mining links
 * 2024-07-02: Changed core deck to kaishi and reworked some old links
